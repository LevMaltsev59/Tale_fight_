...
if __name__ == '__main__':
    ...
    print(
        ...
        Сьюзи: Очень сильный боец с секирой, 150 здоровья, атака от 60-90. Действие - нагрубить, -5% к пощаде. Магия - ярый взмах, тратит 50 магии
        Ральзей: Персонаж-маг, 30 здоровья. Бьёт от 10-30, действие - говорить, +25 к пощаде. Магия - излечение, востанавливает 25 здоровья выбраному бойцу
        Ноэль: Персонаж абсолютно не умеющий драться, 65 здоровья, атакует от 5-10 единиц урона, действие - подбодрить, +5 защиты к выбранному участнику, Магия - фокус, хоть фокус не являеться магией зато он отлично веселит врага, +20% к пощаде. А ещё он отнимает 10 маны
